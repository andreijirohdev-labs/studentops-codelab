 ...
 * v3 - method overriding + super calls
...
class ComProg2_Lab2_v3 {
  ...
  static class Eugenio extends AndreiJiroh implements Self_addon {
    String email;
  ...
  public static void main(String[] args) {
    ...
    String email = "ajhalili2006@andreijiroh.dev";
    
    Eugenio self = new Eugenio();
    self.age = age;
